...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Management Obat",
        route: "/ManagementObat",
      },
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg"
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-teal-900 duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-4 px-4 py-4 lg:mt-5 lg:px-6">
                  ...
                  {group.menuItems.map((menuItem, menuIndex) => (
                    <li key={menuIndex}>
                      {menuItem.subItems ? (
                        <div>
                          <button
                            className="flex w-full text-white items-center gap-2 py-2 px-4 text-left"
